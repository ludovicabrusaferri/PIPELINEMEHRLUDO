...
process_files() {
    ...
    if [[ ! -f "$SUVdir/T1_orientOK.nii.gz" ]]; then
        ...
        echo "T1_orientOK.nii.gz already exists. Skipping conversion."
    fi
    ...
    if [[ ! -f "$SUVdir/brainmask_orientOK.nii.gz" ]]; then
        ...
        echo "brainmask_orientOK.nii.gz already exists. Skipping conversion."
    fi
    ...
    if [[ ! -f "$SUVdir/aparc+aseg_orientOK.nii.gz" ]]; then
        ...
        echo "aparc+aseg_orientOK.nii.gz already exists. Skipping conversion."
    fi
    ...
    if [[ ! -f "$SUVdir/PET_60-90_SUV_orientOK.nii.gz" ]]; then
        ...
        echo "PET_60-90_SUV_orientOK.nii.gz already exists. Skipping processing."
    fi
    ...
    if [[ ! -f "$SUVdir/aparc+aseg_orientOK_BIN.nii.gz" ]]; then
        ...
        echo "aparc+aseg_orientOK_BIN.nii.gz already exists. Skipping binarization."
    fi
}
